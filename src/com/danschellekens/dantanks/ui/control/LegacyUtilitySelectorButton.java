...
public class LegacyUtilitySelectorButton extends Button {
	...
	public LegacyUtilitySelectorButton(UIElement parent, float x, float y, Utility utility) {
		super(parent, new Rectangle(x, y, 30, 30));
	...
	protected void renderInPosition(Artist artist) {
		artist.shape().draw(new Rectangle(0, 0, 30, 30), new Color(0, 0, 0, selectorOpacity));
		artist.image().drawCentered(icon, 15, 15);
	}
