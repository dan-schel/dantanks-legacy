...
import com.danschellekens.dantanks.data.aim.NoTargetAimData;
...
public class NoTargetAimUI extends AimUI {
	Label label;
	
	public NoTargetAimUI(UIElement parent, float x, float y, Level level) {
		super(parent, x, y, level);
		
		label = new Label(this, new Rectangle(0, 0, getWidth(), getHeight()), FontLibrary.getBodyFont());
		label.setText("Fire the utility.".toUpperCase());
