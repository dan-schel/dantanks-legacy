...
public class DriveRight extends Utility {
	public static final String ID = "driveRight";
	...
	protected UtilityShopInfo createShopInfo() {
		UtilityShopInfo info = new UtilityShopInfo("Drive Right (AI)", "Drive Rights (AI)");
